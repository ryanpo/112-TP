...
class PygameGame(object):
    ...
    def init(self):
        ...
        map = terraForm(createList(23,20,3))
        '''
        key:
        A: base
        B: LT1
        ...
        for row in range(len(map)):
            for col in range(len(map[0])):
                if map[row][col] == "B":
                    self.leftWallGroup.add(LeftWall(24+col*24,24+row*24,"Top1"))
                elif map[row][col] == "C":
                    self.leftWallGroup.add(LeftWall(24+col*24,24+row*24,"Top2"))
                    self.floorGroup.add(Floor(24+col*24,24+row*24))
                elif map[row][col] == "D":
                    self.leftWallGroup.add(LeftWall(24+col*24,24+row*24,"Mid"))
                    self.floorGroup.add(Floor(24+col*24,24+row*24))
                elif map[row][col] == "E":
                    self.leftWallGroup.add(LeftWall(24+col*24,24+row*24,"Bot1"))
                    self.floorGroup.add(Floor(24+col*24,24+row*24))
                elif map[row][col] == "F":
                    self.leftWallGroup.add(LeftWall(24+col*24,24+row*24,"Bot2"))
                    self.floorGroup.add(Floor(24+col*24,24+row*24))
                elif map[row][col] == "G":
                    self.rightWallGroup.add(RightWall(24+col*24,24+row*24,"Top1"))
                elif map[row][col] == "H":
                    self.rightWallGroup.add(RightWall(24+col*24,24+row*24,"Top2"))
                    self.floorGroup.add(Floor(24+col*24,24+row*24))
                elif map[row][col] == "I":
                    self.rightWallGroup.add(RightWall(24+col*24,24+row*24,"Mid"))
                    self.floorGroup.add(Floor(24+col*24,24+row*24))
                elif map[row][col] == "J":
                    self.rightWallGroup.add(RightWall(24+col*24,24+row*24,"Bot1"))
                    self.floorGroup.add(Floor(24+col*24,24+row*24))
                elif map[row][col] == "K":
                    self.rightWallGroup.add(RightWall(24+col*24,24+row*24,"Bot2"))
                    self.floorGroup.add(Floor(24+col*24,24+row*24))
                elif map[row][col] == "L":
                    self.midWallTopGroup.add(MidWall(24+col*24,24+row*24,"Top1"))
                elif map[row][col] == "M":
                    self.midWallTopGroup.add(MidWall(24+col*24,24+row*24,"Top2"))
                    self.floorGroup.add(Floor(24+col*24,24+row*24))
                elif map[row][col] == "N":
                    self.midWallBotGroup.add(MidWall(24+col*24,24+row*24,"Bot1"))
                    self.floorGroup.add(Floor(24+col*24,24+row*24))
                elif map[row][col] == "O":
                    self.midWallBotGroup.add(MidWall(24+col*24,24+row*24,"Bot2"))
                    self.floorGroup.add(Floor(24+col*24,24+row*24))
                elif map[row][col] == "A":
                    self.floorGroup.add(Floor(24+col*24,24+row*24))
        ##MISC.##
    ...
    def timerFired(self, dt):
        ...
        self.bulletGroup.update(self.xMargin,self.yMargin)
        self.coinsGroup.update(self.xMargin,self.yMargin)
        self.coinsTextGroup.update(self.xMargin,self.yMargin)
        ##Pointer##
        self.Pointer.update()
        ##Wand Rotation##
        ...
        ##Monster##
        self.monsterGroup.update(self.xMargin,self.yMargin)
